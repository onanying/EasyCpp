...
void easycpp::helpers::log_error(std::string tag, std::string msg)
{
    ...
    easycpp::helpers::file_put_contents("log/error.log", data, FILE_APPEND);
}
...
void easycpp::helpers::log_debug(std::string tag, std::string msg)
{
    ...
    easycpp::helpers::file_put_contents("log/debug.log", data, FILE_APPEND);
}
...
void easycpp::helpers::log_info(std::string tag, std::string msg)
{
    ...
    easycpp::helpers::file_put_contents("log/info.log", data, FILE_APPEND);
}
